...
public class GDestructiblePlatform extends GPlatform{
	...
	public function GDestructiblePlatform() {
        ...
        _positionOffset = 4 * GameConstants.ASSETS_SCALE;
    }
    ...
    override protected function setView():void{
        ...
        _view.texture = AssetsManager.GetDestructiblePlatformTexture();
    }
        ...
        if(!_gamePaused){
            ...
            if(_collideWithBall){
                if(_elapsed < _shakeTime){
                    ...
                    GameSignals.DESTRUCT_EXPLODE.dispatch(_body, index, group);
