...
public class AssetsSD {

    [Embed(source="/assets/sd/fonts/impact_text.fnt", mimeType="application/octet-stream")]
    public static const ImpactTextXml:Class;
    [Embed(source="/assets/sd/fonts/impact_text.png")]
    public static const ImpactTextTexture:Class;
    [Embed(source="/assets/sd/fonts/impact_title.fnt", mimeType="application/octet-stream")]
    public static const ImpactTitleXml:Class;
    [Embed(source="/assets/sd/fonts/impact_title.png")]
    public static const ImpactTitleTexture:Class;
    [Embed(source="/assets/sd/fonts/impact_button.fnt", mimeType="application/octet-stream")]
    public static const ImpactButtonXml:Class;
    [Embed(source="/assets/sd/fonts/impact_button.png")]
    public static const ImpactButtonTexture:Class;
    [Embed(source="/assets/sd/fonts/impact_hud.fnt", mimeType="application/octet-stream")]
    public static const ImpactHUDXml:Class;
    [Embed(source="/assets/sd/fonts/impact_hud.png")]
    public static const ImpactHUDTexture:Class;
    [Embed(source="/assets/sd/fonts/impact_powerup.fnt", mimeType="application/octet-stream")]
    public static const ImpactPowerUpXml:Class;
    [Embed(source="/assets/sd/fonts/impact_powerup.png")]
    public static const ImpactPowerUpTexture:Class;

    [Embed(source="/assets/sd/sprites.xml", mimeType="application/octet-stream")]
    public static const AtlasXml:Class;
    [Embed(source="/assets/sd/sprites.png")]
    public static const AtlasTexture:Class;

    [Embed(source="/assets/sd/background_parallax_512.jpg")]
    public static const BackgroundParallax512Texture:Class;
    [Embed(source="/assets/sd/background_parallax_256.png")]
    public static const BackgroundParallax256Texture:Class;

    [Embed(source="/assets/sd/wall_tile.jpg")]
    public static const WallTexture:Class;
    [Embed(source="/assets/sd/moving_platform_wire.png")]
    public static const MovingPlatformWire:Class;

    [Embed(source="/assets/sd/splash.jpg")]
    public static const Splash:Class;

    public static var gTextureAtlas:GTextureAtlas;

    public static var parallax256:GTexture;
    public static var parallax512:GTexture;
    ...
    public static function init():void {
        ...
        parallax256 = GTextureFactory.createFromEmbedded("bgParallax256Texture", BackgroundParallax256Texture,1, true);
        parallax512 = GTextureFactory.createFromEmbedded("bgParallax512Texture", BackgroundParallax512Texture,1, true);
    }
