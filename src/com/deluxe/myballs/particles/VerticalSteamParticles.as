...
public class VerticalSteamParticles extends GSimpleParticleSystem{
    private var _paused:Boolean = false;
    
    public function VerticalSteamParticles() {
        ...
        initialScale = 0.3;
        endScale = 1.2;
        initialScaleVariance = 0.05;
        endScaleVariance = 0;
        initialVelocity = 200 * GameConstants.ASSETS_SCALE;
        initialVelocityVariance = 100 * GameConstants.ASSETS_SCALE;
        initialAngularVelocity = 0.005;
        initialAngularVelocityVariance = -0.005;
